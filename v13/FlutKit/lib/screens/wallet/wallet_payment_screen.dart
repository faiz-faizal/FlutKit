...
class OptionWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return FxContainer(
      bordered: !isSelected,
      color: isSelected ? theme.colorScheme.primary : theme.colorScheme.background,
      borderRadiusAll: 4,
...
class _TransactionWidget extends StatefulWidget {
  ...
  _TransactionWidget(
      ...
      required this.name,
      required this.date,
      required this.amount, required this.isSend})
      : super(key: key);
          ...
          children: <Widget>[
            ...
            Row(
              children: <Widget>[
                ...
                FxText.titleMedium("\$ ${widget.amount}",
                    fontWeight: 600),
              ],
            )
          ],

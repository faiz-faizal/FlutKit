...
class _HomesScreenState extends State<HomesScreen> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    ...
    navItems = [
      ...
      NavItem('Material Widgets', Images.materialDesignIcon, MaterialWidgetsHome(), 32),
  ...
  void changeDirection() {
    if (AppTheme.textDirection == TextDirection.ltr) {
      Provider.of<AppNotifier>(context, listen: false).changeDirectionality(TextDirection.rtl);
    } else {
      Provider.of<AppNotifier>(context, listen: false).changeDirectionality(TextDirection.ltr);
    }
    setState(() {});
  }
  ...
  Widget _buildDrawer() {
    return FxContainer.none(
      margin: FxSpacing.fromLTRB(16, FxSpacing.safeAreaTop(context) + 16, 16, 16),
      borderRadiusAll: 4,
            ...
            Container(
              ...
              child: Column(
                ...
                children: <Widget>[
                  ...
                  FxSpacing.height(16),
                  FxText.bodyMedium("Flutter 3.7.0 (Latest)", fontWeight: 600, letterSpacing: 0.2),
                ],
              ),
            ),
            FxSpacing.height(32),
            Container(
              ...
              child: Column(
                children: [
                      ...
                      children: [
                        FxContainer(
                          ...
                          child: Image(
                            height: 20,
                            width: 20,
                            image: AssetImage(!isDark ? Images.darkModeOutline : Images.lightModeOutline),
                  ...
                  InkWell(
                    onTap: () {
                      showDialog(context: context, builder: (BuildContext context) => SelectLanguageDialog());
                    },
                    highlightColor: Colors.transparent,
                    splashColor: Colors.transparent,
                    child: Row(
                      ...
                      children: [
                        FxContainer(
                          ...
                          child: Image(
                            height: 20,
                            width: 20,
                            image: AssetImage(AppTheme.textDirection == TextDirection.ltr
  ...
  List<Widget> buildTab() {
    ...
    for (int i = 0; i < navItems.length; i++) {
      tabs.add(SVG(navItems[i].icon,
          color:
              (currentIndex == i) ? theme.colorScheme.primary : theme.colorScheme.onBackground.withAlpha(220),

...
class _OTPVerificationScreenState extends State<OTPVerificationScreen> {
  ...
  void initState() {
    ...
    _otp2Controller!.addListener(() {
      if (_otp2Controller!.text.isNotEmpty) {
        _otp3FocusNode!.requestFocus();
      }
    });

    _otp3Controller!.addListener(() {
      if (_otp3Controller!.text.isNotEmpty) {
      ...
      children: <Widget>[
        Center(
          child: Column(
            ...
            children: <Widget>[
              MyText.titleLarge("OTP Verification"),
              Container(
                    ...
                    ExpansionPanel(
                        ...
                        headerBuilder: (BuildContext context, bool isExpanded) {
                          return Container(
                              ...
                              child: MyText.titleMedium("Number",
                            ...
                            children: <Widget>[
                              TextFormField(
                                ...
                                decoration: InputDecoration(
                                  prefixText: "+91 ",
                                  prefixStyle: MyTextStyle.titleSmall(
                                      letterSpacing: 0.1,
                                      color: theme.colorScheme.onBackground,
                                      fontWeight: 500),
                                ...
                                child: Row(
                                  ...
                                  children: <Widget>[
                                    TextButton(
                                        ...
                                        child: MyText.bodyMedium("Call Me",
                                            fontWeight: 600,
                                            color: theme
                                    ...
                                    MyButton(
                                        ...
                                        child: MyText.bodyMedium("Send OTP",
                                            fontWeight: 600,
                                            color:
                                ...
                                Row(
                                  ...
                                  children: <Widget>[
                                    Row(
                                      mainAxisSize: MainAxisSize.min,
                                      children: <Widget>[
                                        MyText.bodySmall("Resend in ",
                                            fontWeight: 600,
                                            letterSpacing: 0.2),
                                        MyText.bodySmall("00:59",
                                            fontWeight: 500),
                                      ],
                                    ),
                                    MyButton(
